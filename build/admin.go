...
//   food-scaner --list-users
//   food-scaner --set-role  <auth_id> <free|tester|pro>
//   food-scaner --set-limit <auth_id> <n>     (tester daily AI ops)
//   food-scaner --grant-free <auth_id> <n>    (add lifetime free AI ops)
